...
cp submit_multi_getR_quever_signal.sub submit_multi_getR_quever_signal_temp.sub
sed -i "/listFile = /c listFile = ${prefix}_for_submit.txt" submit_multi_getR_quever_signal_temp.sub
sed -i "/outputname = /c outputname = ${prefix}" submit_multi_getR_quever_signal_temp.sub
condor_submit submit_multi_getR_quever_signal_temp.sub |tee ${prefix}.log
